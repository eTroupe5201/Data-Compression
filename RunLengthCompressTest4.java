...
class RunLengthCompressTest4 {
	...
	Path tempDir;
		...
		//   FileHelper helper = new FileHelper();
			...
			Path inputFilePath = tempDir.resolve("inputTest4.txt");// create inputpath with temp directory
			Files.writeString(inputFilePath, "This file was compressed with run length compress");// create test file for input

			Path outputFilePath = tempDir.resolve("outputTest4.txt");// create outputpath with temp directory
