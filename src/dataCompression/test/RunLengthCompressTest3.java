...
class RunLengthCompressTest3 {
	...
	Path tempDir;
		...
		//   FileHelper helper = new FileHelper();
			...
			Path inputFilePath = tempDir.resolve("inputTest2.txt");// create inputpath with temp directory
			Files.writeString(inputFilePath, "This is a test");// create test file for input

			Path outputFilePath = tempDir.resolve("outputTest2.txt");// create outputpath with temp directory
